...
class S7(object):
    ...
    def request_ssl_17(self, data_ssl_index):
        ...
        if data_ssl_index == 1:  # 0x0001 - component identification
            ...
            ssl_resp_data = pack(
                ...
                str_to_bytes("6ES7 214-1AD23-0XB0"),
    ...
    def request_ssl_28_1(self, data_ssl_index):
        ...
        # Module
        module_bytes_value = str_to_bytes("6ES7 214-1AD23-0XB0")
        ssl_resp_data += pack(
            "!H20sHHH",
        ...
        # Basic Hardware
        hardware_bytes_value = str_to_bytes("6ES7 214-1AD23-0XB0")
        ssl_resp_data += pack(
           "!H20sHHH",
